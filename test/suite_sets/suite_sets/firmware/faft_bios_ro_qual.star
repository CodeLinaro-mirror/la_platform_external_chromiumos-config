...
def _faft_bios_ro_qual():
    return create.suite(
        ...
        tests = [
            ...
            "tast.firmware.ECPowerG3.power_state_usb_plugged_in",
            ...
            "tast.firmware.RecoveryCacheBootKeys.dev",
            "tast.firmware.RecoveryCacheBootKeys.normal",
            ...
            "tast.firmware.UpdateVersion.firmware_data_key_version",
            "tast.firmware.UpdateVersion.firmware_version",

...
func (ProvisionFirmwareResponse_Status) EnumDescriptor() ([]byte, []int) {
	return file_chromiumos_test_api_firmware_provision_proto_rawDescGZIP(), []int{3, 0}
}
...
// TODO(b/274780330): Delete this and use GenericProvisionService
type ProvisionFirmwareRequest struct {
	...
	// them individually over futility.
	// ec_ro over Servo is flashed using flash_ec.
	DetailedRequest *api1.FirmwareConfig `protobuf:"bytes,2,opt,name=detailed_request,json=detailedRequest,proto3" json:"detailed_request,omitempty"`
	...
	// Access to cache service is required.
	CacheServerAddress *api.IpEndpoint `protobuf:"bytes,10,opt,name=cache_server_address,json=cacheServerAddress,proto3" json:"cache_server_address,omitempty"`
...
func (x *ProvisionFirmwareRequest) GetCacheServerAddress() *api.IpEndpoint {
	if x != nil {
		return x.CacheServerAddress
	}
	return nil
...
func (x *ProvisionFirmwareMetadata) Reset() {
	*x = ProvisionFirmwareMetadata{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chromiumos_test_api_firmware_provision_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProvisionFirmwareMetadata) Descriptor() ([]byte, []int) {
	return file_chromiumos_test_api_firmware_provision_proto_rawDescGZIP(), []int{4}
}
...
var file_chromiumos_test_api_firmware_provision_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x79, 0x0a, 0x20, 0x46, 0x69, 0x72, 0x6d, 0x77, 0x61, 0x72, 0x65, 0x50,
	0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x72, 0x74, 0x75, 0x70, 0x4d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x55, 0x0a, 0x14, 0x63, 0x61, 0x63, 0x68, 0x65,
	...
	0x49, 0x70, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x12, 0x63, 0x61, 0x63, 0x68,
	0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x71,
	0x0a, 0x20, 0x46, 0x69, 0x72, 0x6d, 0x77, 0x61, 0x72, 0x65, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73,
	0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0x12, 0x4d, 0x0a, 0x0f, 0x66, 0x69, 0x72, 0x6d, 0x77, 0x61, 0x72, 0x65, 0x5f, 0x63,
	...
	,
	...
	0x52, 0x10, 0x64, 0x75, 0x74, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x12, 0x53, 0x0a, 0x13, 0x63, 0x72, 0x6f, 0x73, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x6f,
	0x64, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	0x22, 0xe4, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0d, 0x0a, 0x09, 0x53,
	...
	0x44, 0x10, 0x03, 0x12, 0x31, 0x0a, 0x2d, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x46, 0x49,
	...
	,
	...
	0x6e, 0x22, 0x39, 0xd2, 0x41, 0x36, 0x0a, 0x19, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f,
	0x6e, 0x46, 0x69, 0x72, 0x6d, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x19, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x46, 0x69, 0x72, 0x6d,
	0x77, 0x61, 0x72, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x42, 0x2f, 0x5a, 0x2d,
...
var file_chromiumos_test_api_firmware_provision_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_chromiumos_test_api_firmware_provision_proto_goTypes = []interface{}{
	...
	(*ProvisionFirmwareRequest)(nil),         // 3: chromiumos.test.api.ProvisionFirmwareRequest
	(*ProvisionFirmwareResponse)(nil),        // 4: chromiumos.test.api.ProvisionFirmwareResponse
	(*ProvisionFirmwareMetadata)(nil),        // 5: chromiumos.test.api.ProvisionFirmwareMetadata
	(*api.IpEndpoint)(nil),                   // 6: chromiumos.test.lab.api.IpEndpoint
	(*api1.FirmwareConfig)(nil),              // 7: chromiumos.build.api.FirmwareConfig
...
var file_chromiumos_test_api_firmware_provision_proto_depIdxs = []int32{
	6, // 0: chromiumos.test.api.FirmwareProvisionStartupMetadata.cache_server_address:type_name -> chromiumos.test.lab.api.IpEndpoint
	7, // 1: chromiumos.test.api.FirmwareProvisionInstallMetadata.firmware_config:type_name -> chromiumos.build.api.FirmwareConfig
	7, // 2: chromiumos.test.api.ProvisionFirmwareRequest.detailed_request:type_name -> chromiumos.build.api.FirmwareConfig
	6, // 3: chromiumos.test.api.ProvisionFirmwareRequest.dut_server_address:type_name -> chromiumos.test.lab.api.IpEndpoint
	6, // 4: chromiumos.test.api.ProvisionFirmwareRequest.cros_servod_address:type_name -> chromiumos.test.lab.api.IpEndpoint
	6, // 5: chromiumos.test.api.ProvisionFirmwareRequest.cache_server_address:type_name -> chromiumos.test.lab.api.IpEndpoint
	0, // 6: chromiumos.test.api.ProvisionFirmwareResponse.status:type_name -> chromiumos.test.api.ProvisionFirmwareResponse.Status
	3, // 7: chromiumos.test.api.FirmwareProvisionService.Provision:input_type -> chromiumos.test.api.ProvisionFirmwareRequest
	8, // 8: chromiumos.test.api.FirmwareProvisionService.Provision:output_type -> chromiumos.longrunning.Operation
...
func file_chromiumos_test_api_firmware_provision_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_chromiumos_test_api_firmware_provision_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {

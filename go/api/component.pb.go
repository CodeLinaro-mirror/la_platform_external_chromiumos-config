...
type Component_Touchscreen struct {
	...
	// Firmware file name formatted based on the vendor specific naming
	// conventions.
	FwFileName           string   `protobuf:"bytes,4,opt,name=fw_file_name,json=fwFileName,proto3" json:"fw_file_name,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Component_Touchscreen) GetFwFileName() string {
	if m != nil {
		return m.FwFileName
	}
	return ""
...
var fileDescriptor_c6bb55af29234765 = []byte{
	...
	,
}

...
func (Result_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5e83d657830dbeb4, []int{1, 0}
}
...
func (Result_Error_Source) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5e83d657830dbeb4, []int{1, 0, 0}
}
...
func (Result_Error_Severity) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5e83d657830dbeb4, []int{1, 0, 1}
}
...
type Result struct {
	...
	State Result_State `protobuf:"varint,1,opt,name=state,proto3,enum=chromiumos.config.api.test.rtd.v1.Result_State" json:"state,omitempty"`
...
type Result_Error struct {
	...
	Source Result_Error_Source `protobuf:"varint,1,opt,name=source,proto3,enum=chromiumos.config.api.test.rtd.v1.Result_Error_Source" json:"source,omitempty"`
	// Severity of reported error.
	Severity Result_Error_Severity `protobuf:"varint,2,opt,name=severity,proto3,enum=chromiumos.config.api.test.rtd.v1.Result_Error_Severity" json:"severity,omitempty"`
...
func (*ArchiveArtifactResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5e83d657830dbeb4, []int{7}
}
...
func init() {
	proto.RegisterEnum("chromiumos.config.api.test.rtd.v1.Result_State", Result_State_name, Result_State_value)
	proto.RegisterEnum("chromiumos.config.api.test.rtd.v1.Result_Error_Source", Result_Error_Source_name, Result_Error_Source_value)
	proto.RegisterEnum("chromiumos.config.api.test.rtd.v1.Result_Error_Severity", Result_Error_Severity_name, Result_Error_Severity_value)
	proto.RegisterType((*ProgressSinkClientConfig)(nil), "chromiumos.config.api.test.rtd.v1.ProgressSinkClientConfig")
	proto.RegisterType((*Result)(nil), "chromiumos.config.api.test.rtd.v1.Result")
	proto.RegisterType((*Result_Error)(nil), "chromiumos.config.api.test.rtd.v1.Result.Error")
...
var fileDescriptor_5e83d657830dbeb4 = []byte{
	...
	,

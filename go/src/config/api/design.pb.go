...
// source: src/config/api/design.proto
...
func (Design_Config_Constraint_Level) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_8fe123dfb3956cee, []int{0, 0, 0, 0}
}
...
func (*Design) Descriptor() ([]byte, []int) {
	return fileDescriptor_8fe123dfb3956cee, []int{0}
}
...
func (*Design_Config) Descriptor() ([]byte, []int) {
	return fileDescriptor_8fe123dfb3956cee, []int{0, 0}
}
...
func (*Design_Config_Constraint) Descriptor() ([]byte, []int) {
	return fileDescriptor_8fe123dfb3956cee, []int{0, 0, 0}
}
...
func (*DesignList) Descriptor() ([]byte, []int) {
	return fileDescriptor_8fe123dfb3956cee, []int{1}
}
...
func init() { proto.RegisterFile("src/config/api/design.proto", fileDescriptor_8fe123dfb3956cee) }

var fileDescriptor_8fe123dfb3956cee = []byte{
	// 486 bytes of a gzipped FileDescriptorProto
	,
}

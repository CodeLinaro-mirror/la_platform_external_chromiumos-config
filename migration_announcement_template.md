**Fill in all sections demarcated in <> brackets and then delete this.**

**Tldr: Configuration for <program> will now be managed on a per-project basis
...
<repos> and model.yaml will be deleted from <private overlay>. A few resources
to get started:
...
Please read [go/cros-boxster-site](http://go/cros-boxster-site) and
[go/cros-boxster](http://go/cros-boxster) for more background. See
[go/cros-boxster-](http://go/cros-boxster-) for analytics and query examples.

...
_HARDWARETOPOLOGY.fields_by_name['screen'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['form_factor'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['audio'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['stylus'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['keyboard'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['thermal'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['camera'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['accelerometer_gyroscope_magnetometer'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['fingerprint'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['proximity_sensor'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['daughter_board'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['non_volatile_storage'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['ram'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['wifi'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['lte_board'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['sd_reader'].message_type = api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['motherboard_usb'].message_type = api_dot_topology__pb2._TOPOLOGY
DESCRIPTOR.message_types_by_name['HardwareTopology'] = _HARDWARETOPOLOGY
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

HardwareTopology = _reflection.GeneratedProtocolMessageType('HardwareTopology', (_message.Message,), dict(
  DESCRIPTOR = _HARDWARETOPOLOGY,
  __module__ = 'api.hardware_topology_pb2'

...
_COMPONENT_SOC_VIDEOACCELERATION = _descriptor.EnumDescriptor(
  name='VideoAcceleration',
  full_name='chromiumos.config.api.Component.Soc.VideoAcceleration',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='VIDE_ACCELERATION_UNDEFINED', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_COMPONENT_SOC_VIDEOACCELERATION)
...
_COMPONENT_SOC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='video_acceleration', full_name='chromiumos.config.api.Component.Soc.video_acceleration', index=3,
  ...
  enum_types=[
    ...
    _COMPONENT_SOC_VIDEOACCELERATION,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_COMPONENT_SOC.fields_by_name['video_acceleration'].enum_type = _COMPONENT_SOC_VIDEOACCELERATION
_COMPONENT_SOC.containing_type = _COMPONENT
_COMPONENT_SOC_ARCHITECTURE.containing_type = _COMPONENT_SOC
_COMPONENT_SOC_VIDEOACCELERATION.containing_type = _COMPONENT_SOC

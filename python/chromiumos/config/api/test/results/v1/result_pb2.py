...
from chromiumos.config.api.test.results.v1 import machine_id_pb2 as chromiumos_dot_config_dot_api_dot_test_dot_results_dot_v1_dot_machine__id__pb2
from chromiumos.config.api.test.results.v1 import result_id_pb2 as chromiumos_dot_config_dot_api_dot_test_dot_results_dot_v1_dot_result__id__pb2
from chromiumos.config.api.test.results.v1 import software_config_id_pb2 as chromiumos_dot_config_dot_api_dot_test_dot_results_dot_v1_dot_software__config__id__pb2
from chromiumos.config.api.test.results.v1 import software_overrides_config_pb2 as chromiumos_dot_config_dot_api_dot_test_dot_results_dot_v1_dot_software__overrides__config__pb2
from chromiumos.config.api.test.results.graphics.v1 import trace_id_pb2 as chromiumos_dot_config_dot_api_dot_test_dot_results_dot_graphics_dot_v1_dot_trace__id__pb2

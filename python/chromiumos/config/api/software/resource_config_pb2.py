...
_RESOURCECONFIG_ONDEMANDGOVERNOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='sampling-rate-ms', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
ResourceConfig = _reflection.GeneratedProtocolMessageType('ResourceConfig', (_message.Message,), dict(
  ...
  OndemandGovernor = _reflection.GeneratedProtocolMessageType('OndemandGovernor', (_message.Message,), dict(
  ...
  Governor = _reflection.GeneratedProtocolMessageType('Governor', (_message.Message,), dict(
  ...
  PowerPreferences = _reflection.GeneratedProtocolMessageType('PowerPreferences', (_message.Message,), dict(
  ...
  PowerSourcePreferences = _reflection.GeneratedProtocolMessageType('PowerSourcePreferences', (_message.Message,), dict(

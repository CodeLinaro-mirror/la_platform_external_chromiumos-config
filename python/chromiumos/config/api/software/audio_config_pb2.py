...
_AUDIOCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='module_file', full_name='chromiumos.config.api.software.AudioConfig.module_file', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='board_file', full_name='chromiumos.config.api.software.AudioConfig.board_file', index=7,

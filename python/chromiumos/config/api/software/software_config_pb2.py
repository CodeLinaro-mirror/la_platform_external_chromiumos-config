...
from chromiumos.config.api.software import scheduler_config_pb2 as chromiumos_dot_config_dot_api_dot_software_dot_scheduler__config__pb2
...
_SOFTWARECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='scheduler_config', full_name='chromiumos.config.api.software.SoftwareConfig.scheduler_config', index=18,
...
_SOFTWARECONFIG.fields_by_name['scheduler_config'].message_type = chromiumos_dot_config_dot_api_dot_software_dot_scheduler__config__pb2._SCHEDULERCONFIG

...
from chromiumos.config.api.software import alt_firmware_config_pb2 as chromiumos_dot_config_dot_api_dot_software_dot_alt__firmware__config__pb2
...
_SOFTWARECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='alt_firmware_config', full_name='chromiumos.config.api.software.SoftwareConfig.alt_firmware_config', index=19,
...
_SOFTWARECONFIG.fields_by_name['alt_firmware_config'].message_type = chromiumos_dot_config_dot_api_dot_software_dot_alt__firmware__config__pb2._ALTFIRMWARECONFIG

...
HealthConfig = _reflection.GeneratedProtocolMessageType('HealthConfig', (_message.Message,), dict(
  ...
  CachedVpd = _reflection.GeneratedProtocolMessageType('CachedVpd', (_message.Message,), dict(
  ...
  BatteryHealth = _reflection.GeneratedProtocolMessageType('BatteryHealth', (_message.Message,), dict(
  ...
  Routines = _reflection.GeneratedProtocolMessageType('Routines', (_message.Message,), dict(

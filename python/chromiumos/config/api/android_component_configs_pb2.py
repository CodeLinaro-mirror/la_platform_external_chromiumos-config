...
_CAMERACONFIGURATIONTYPE_CAMERAHWCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encoder_profile', full_name='chromiumos.config.api.CameraConfigurationType.CameraHWConfig.encoder_profile', index=7,
  ...
  oneofs=[
    ...
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_encoder_profile', full_name='chromiumos.config.api.CameraConfigurationType.CameraHWConfig._encoder_profile',
...
_CAMERACONFIGURATIONTYPE_CAMERAHWCONFIG.oneofs_by_name['_encoder_profile'].fields.append(
  _CAMERACONFIGURATIONTYPE_CAMERAHWCONFIG.fields_by_name['encoder_profile'])
_CAMERACONFIGURATIONTYPE_CAMERAHWCONFIG.fields_by_name['encoder_profile'].containing_oneof = _CAMERACONFIGURATIONTYPE_CAMERAHWCONFIG.oneofs_by_name['_encoder_profile']

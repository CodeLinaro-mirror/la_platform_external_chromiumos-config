...
_PROGRAM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='design_config_id_segments', full_name='chromiumos.config.api.Program.design_config_id_segments', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='device_signer_configs', full_name='chromiumos.config.api.Program.device_signer_configs', index=7,

...
_PROGRAM_PLATFORM_SCHEDULERTUNE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='boost_top_app', full_name='chromiumos.config.api.Program.Platform.SchedulerTune.boost_top_app', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='boost_arcvm', full_name='chromiumos.config.api.Program.Platform.SchedulerTune.boost_arcvm', index=4,
...
_PROGRAM_PLATFORM_ARCSETTINGS = _descriptor.Descriptor(
  name='ArcSettings',
  full_name='chromiumos.config.api.Program.Platform.ArcSettings',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='media_codecs_suffix', full_name='chromiumos.config.api.Program.Platform.ArcSettings.media_codecs_suffix', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PROGRAM_PLATFORM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='arc_settings', full_name='chromiumos.config.api.Program.Platform.arc_settings', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hevc_support', full_name='chromiumos.config.api.Program.Platform.hevc_support', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='resource_config', full_name='chromiumos.config.api.Program.Platform.resource_config', index=9,
  ...
  nested_types=[_PROGRAM_PLATFORM_CAPABILITIES, _PROGRAM_PLATFORM_SCHEDULERTUNE, _PROGRAM_PLATFORM_ARCSETTINGS, ],
  enum_types=[
...
_PROGRAM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='base_program', full_name='chromiumos.config.api.Program.base_program', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mosys_platform_name', full_name='chromiumos.config.api.Program.mosys_platform_name', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='platform', full_name='chromiumos.config.api.Program.platform', index=5,
      number=11, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='audio_config', full_name='chromiumos.config.api.Program.audio_config', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='generate_camera_media_profiles', full_name='chromiumos.config.api.Program.generate_camera_media_profiles', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='design_config_constraints', full_name='chromiumos.config.api.Program.design_config_constraints', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='component_quals', full_name='chromiumos.config.api.Program.component_quals', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='firmware_configuration_segments', full_name='chromiumos.config.api.Program.firmware_configuration_segments', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ssfc_segments', full_name='chromiumos.config.api.Program.ssfc_segments', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='design_config_id_segments', full_name='chromiumos.config.api.Program.design_config_id_segments', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='device_signer_configs', full_name='chromiumos.config.api.Program.device_signer_configs', index=13,
...
_PROGRAM_PLATFORM_ARCSETTINGS.containing_type = _PROGRAM_PLATFORM
...
Program = _reflection.GeneratedProtocolMessageType('Program', (_message.Message,), {
  ...
  'Platform' : _reflection.GeneratedProtocolMessageType('Platform', (_message.Message,), {
    ...
    'ArcSettings' : _reflection.GeneratedProtocolMessageType('ArcSettings', (_message.Message,), {
      'DESCRIPTOR' : _PROGRAM_PLATFORM_ARCSETTINGS,
      '__module__' : 'chromiumos.config.api.program_pb2'
      # @@protoc_insertion_point(class_scope:chromiumos.config.api.Program.Platform.ArcSettings)
      })
    ,
...
_sym_db.RegisterMessage(Program.Platform.ArcSettings)

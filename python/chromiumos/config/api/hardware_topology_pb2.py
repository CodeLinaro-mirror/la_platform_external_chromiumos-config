...
_HARDWARETOPOLOGY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='battery', full_name='chromiumos.config.api.HardwareTopology.battery', index=30,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='dgpu', full_name='chromiumos.config.api.HardwareTopology.dgpu', index=31,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='uwb', full_name='chromiumos.config.api.HardwareTopology.uwb', index=32,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='detachable_base', full_name='chromiumos.config.api.HardwareTopology.detachable_base', index=33,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='soc', full_name='chromiumos.config.api.HardwareTopology.soc', index=34,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fan', full_name='chromiumos.config.api.HardwareTopology.fan', index=35,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='firmware_features', full_name='chromiumos.config.api.HardwareTopology.firmware_features', index=36,
...
_HARDWARETOPOLOGY.fields_by_name['battery'].message_type = chromiumos_dot_config_dot_api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['dgpu'].message_type = chromiumos_dot_config_dot_api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['uwb'].message_type = chromiumos_dot_config_dot_api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['detachable_base'].message_type = chromiumos_dot_config_dot_api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['soc'].message_type = chromiumos_dot_config_dot_api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['fan'].message_type = chromiumos_dot_config_dot_api_dot_topology__pb2._TOPOLOGY
_HARDWARETOPOLOGY.fields_by_name['firmware_features'].message_type = chromiumos_dot_config_dot_api_dot_topology__pb2._TOPOLOGY

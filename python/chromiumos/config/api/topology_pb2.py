...
HardwareFeatures = _reflection.GeneratedProtocolMessageType('HardwareFeatures', (_message.Message,), dict(
  ...
  PowerSupply = _reflection.GeneratedProtocolMessageType('PowerSupply', (_message.Message,), dict(

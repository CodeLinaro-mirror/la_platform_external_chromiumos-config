...
_HARDWAREFEATURES_EMBEDDEDCONTROLLER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='feature_tablet_mode_angle', full_name='chromiumos.config.api.HardwareFeatures.EmbeddedController.feature_tablet_mode_angle', index=7,
      number=8, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_HARDWAREFEATURES_EMBEDDEDCONTROLLER.fields_by_name['feature_tablet_mode_angle'].enum_type = _HARDWAREFEATURES_PRESENT

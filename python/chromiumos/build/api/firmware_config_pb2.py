...
_FIRMWARECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ec_rw_payload', full_name='chromiumos.build.api.FirmwareConfig.ec_rw_payload', index=4,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='has_ec_component_manifest', full_name='chromiumos.build.api.FirmwareConfig.has_ec_component_manifest', index=6,
...
_FIRMWARE_BUILDTARGETS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='zephyr_detachable_base', full_name='chromiumos.build.api.Firmware.BuildTargets.zephyr_detachable_base', index=9,

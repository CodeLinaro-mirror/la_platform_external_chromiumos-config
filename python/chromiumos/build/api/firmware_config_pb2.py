...
_FIRMWAREPAYLOAD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='firmware_image_name', full_name='chromiumos.build.api.FirmwarePayload.firmware_image_name', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='chromiumos.build.api.FirmwarePayload.type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='version', full_name='chromiumos.build.api.FirmwarePayload.version', index=2,

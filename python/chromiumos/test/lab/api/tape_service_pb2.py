...
CallTapeRequest = _reflection.GeneratedProtocolMessageType('CallTapeRequest', (_message.Message,), dict(
...
CallTapeResponse = _reflection.GeneratedProtocolMessageType('CallTapeResponse', (_message.Message,), dict(

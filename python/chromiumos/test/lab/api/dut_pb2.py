...
_SIMINFO_STATE = _descriptor.EnumDescriptor(
  name='State',
  full_name='chromiumos.test.lab.api.SIMInfo.State',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_sym_db.RegisterEnumDescriptor(_SIMINFO_STATE)

_SIMINFO_FEATURE = _descriptor.EnumDescriptor(
  name='Feature',
  full_name='chromiumos.test.lab.api.SIMInfo.Feature',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_sym_db.RegisterEnumDescriptor(_SIMINFO_FEATURE)
...
_SIMINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='state', full_name='chromiumos.test.lab.api.SIMInfo.state', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='features', full_name='chromiumos.test.lab.api.SIMInfo.features', index=6,
...
_SIMINFO.fields_by_name['state'].enum_type = _SIMINFO_STATE
_SIMINFO.fields_by_name['features'].enum_type = _SIMINFO_FEATURE
_SIMINFO_STATE.containing_type = _SIMINFO
_SIMINFO_FEATURE.containing_type = _SIMINFO

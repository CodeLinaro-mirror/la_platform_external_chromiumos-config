...
_PASITHOST_DEVICE = _descriptor.Descriptor(
  ...
  nested_types=[_PASITHOST_DEVICE_POWERSUPPLY, ],
  enum_types=[
...
_DUT_CHROMEOS.fields_by_name['pasit_host'].message_type = _PASITHOST

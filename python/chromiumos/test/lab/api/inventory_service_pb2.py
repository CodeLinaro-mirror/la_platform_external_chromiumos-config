...
GetDutTopologyRequest = _reflection.GeneratedProtocolMessageType('GetDutTopologyRequest', (_message.Message,), dict(
...
GetDutTopologyResponse = _reflection.GeneratedProtocolMessageType('GetDutTopologyResponse', (_message.Message,), dict(

...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='chromiumos/test/internal/test_harness.proto',
...
_TESTHARNESS_MANUAL = _descriptor.Descriptor(
  name='Manual',
  full_name='chromiumos.test.internal.TestHarness.Manual',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_TESTHARNESS_TAST = _descriptor.Descriptor(
  name='Tast',
  full_name='chromiumos.test.internal.TestHarness.Tast',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_TESTHARNESS_TAUTO = _descriptor.Descriptor(
  name='Tauto',
  full_name='chromiumos.test.internal.TestHarness.Tauto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_TESTHARNESS = _descriptor.Descriptor(
  name='TestHarness',
  full_name='chromiumos.test.internal.TestHarness',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='test_harness_type', full_name='chromiumos.test.internal.TestHarness.test_harness_type',
...
TestHarness = _reflection.GeneratedProtocolMessageType('TestHarness', (_message.Message,), dict(
  ...
  Manual = _reflection.GeneratedProtocolMessageType('Manual', (_message.Message,), dict(
    ...
    __module__ = 'chromiumos.test.internal.test_harness_pb2'
    # @@protoc_insertion_point(class_scope:chromiumos.test.internal.TestHarness.Manual)
    ))
  ,
  ...
  Tast = _reflection.GeneratedProtocolMessageType('Tast', (_message.Message,), dict(
    ...
    __module__ = 'chromiumos.test.internal.test_harness_pb2'
    # @@protoc_insertion_point(class_scope:chromiumos.test.internal.TestHarness.Tast)
    ))
  ,
  ...
  Tauto = _reflection.GeneratedProtocolMessageType('Tauto', (_message.Message,), dict(
    ...
    __module__ = 'chromiumos.test.internal.test_harness_pb2'
    # @@protoc_insertion_point(class_scope:chromiumos.test.internal.TestHarness.Tauto)
    ))
  ,

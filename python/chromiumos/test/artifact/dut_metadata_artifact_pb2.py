...
DutMetadataArtifact = _reflection.GeneratedProtocolMessageType('DutMetadataArtifact', (_message.Message,), dict(
...
DutInfoArtifact = _reflection.GeneratedProtocolMessageType('DutInfoArtifact', (_message.Message,), dict(

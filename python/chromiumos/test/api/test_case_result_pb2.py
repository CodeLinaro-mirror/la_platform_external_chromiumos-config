...
_TESTCASERESULT = _descriptor.Descriptor(
  ...
  nested_types=[_TESTCASERESULT_ERROR, _TESTCASERESULT_ARTIFACTS, _TESTCASERESULT_PASS, _TESTCASERESULT_FAIL, _TESTCASERESULT_CRASH, _TESTCASERESULT_ABORT, _TESTCASERESULT_SKIP, _TESTCASERESULT_NOTRUN, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,

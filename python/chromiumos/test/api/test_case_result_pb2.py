...
_TESTCASERESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reason', full_name='chromiumos.test.api.TestCaseResult.reason', index=7,
  ...
  nested_types=[_TESTCASERESULT_ARTIFACTS, _TESTCASERESULT_PASS, _TESTCASERESULT_FAIL, _TESTCASERESULT_CRASH, _TESTCASERESULT_ABORT, _TESTCASERESULT_SKIP, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
TestCaseResult = _reflection.GeneratedProtocolMessageType('TestCaseResult', (_message.Message,), dict(
  ...
  Skip = _reflection.GeneratedProtocolMessageType('Skip', (_message.Message,), dict(

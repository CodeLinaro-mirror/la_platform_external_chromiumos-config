...
_CACHEREQUEST_RETRY = _descriptor.Descriptor(
  name='Retry',
  full_name='chromiumos.test.api.CacheRequest.Retry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='times', full_name='chromiumos.test.api.CacheRequest.Retry.times', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='interval_ms', full_name='chromiumos.test.api.CacheRequest.Retry.interval_ms', index=1,
...
_CACHEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='retry', full_name='chromiumos.test.api.CacheRequest.retry', index=5,
  ...
  nested_types=[_CACHEREQUEST_LOCALFILE, _CACHEREQUEST_PIPE, _CACHEREQUEST_GSFILE, _CACHEREQUEST_GSZIPFILE, _CACHEREQUEST_GSTARFILE, _CACHEREQUEST_RETRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_CACHEREQUEST_RETRY.containing_type = _CACHEREQUEST
...
_CACHEREQUEST.fields_by_name['retry'].message_type = _CACHEREQUEST_RETRY
...
CacheRequest = _reflection.GeneratedProtocolMessageType('CacheRequest', (_message.Message,), dict(
  ...
  GSZipFile = _reflection.GeneratedProtocolMessageType('GSZipFile', (_message.Message,), dict(
  ...
  GSTARFile = _reflection.GeneratedProtocolMessageType('GSTARFile', (_message.Message,), dict(
...
CacheResponse = _reflection.GeneratedProtocolMessageType('CacheResponse', (_message.Message,), dict(
...
CacheMetadata = _reflection.GeneratedProtocolMessageType('CacheMetadata', (_message.Message,), dict(
...
ForceReconnectRequest = _reflection.GeneratedProtocolMessageType('ForceReconnectRequest', (_message.Message,), dict(
...
ForceReconnectResponse = _reflection.GeneratedProtocolMessageType('ForceReconnectResponse', (_message.Message,), dict(
...
ForceReconnectMetadata = _reflection.GeneratedProtocolMessageType('ForceReconnectMetadata', (_message.Message,), dict(
...
DetectDeviceConfigIdRequest = _reflection.GeneratedProtocolMessageType('DetectDeviceConfigIdRequest', (_message.Message,), dict(
...
DetectDeviceConfigIdResponse = _reflection.GeneratedProtocolMessageType('DetectDeviceConfigIdResponse', (_message.Message,), dict(

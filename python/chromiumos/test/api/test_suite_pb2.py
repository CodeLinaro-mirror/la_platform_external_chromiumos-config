...
_TESTSUITE_TESTCASETAGCRITERIA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='test_names', full_name='chromiumos.test.api.TestSuite.TestCaseTagCriteria.test_names', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='test_name_excludes', full_name='chromiumos.test.api.TestSuite.TestCaseTagCriteria.test_name_excludes', index=3,
...
_TESTSUITE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='execution_metadata', full_name='chromiumos.test.api.TestSuite.execution_metadata', index=6,
...
_TESTSUITE.fields_by_name['execution_metadata'].message_type = chromiumos_dot_test_dot_api_dot_test__execution__metadata__pb2._EXECUTIONMETADATA

...
CrosPublishRequest = _reflection.GeneratedProtocolMessageType('CrosPublishRequest', (_message.Message,), dict(
...
CrosPublishResponse = _reflection.GeneratedProtocolMessageType('CrosPublishResponse', (_message.Message,), dict(

...
_ANDROIDOSIMAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='os_version', full_name='chromiumos.test.api.AndroidOsImage.os_version', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='ref_oneof', full_name='chromiumos.test.api.AndroidOsImage.ref_oneof',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_INSTALLEDANDROIDOS = _descriptor.Descriptor(
  name='InstalledAndroidOS',
  full_name='chromiumos.test.api.InstalledAndroidOS',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='build_id', full_name='chromiumos.test.api.InstalledAndroidOS.build_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='os_version', full_name='chromiumos.test.api.InstalledAndroidOS.os_version', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='incremental_version', full_name='chromiumos.test.api.InstalledAndroidOS.incremental_version', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ANDROIDPROVISIONRESPONSEMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='installed_android_os', full_name='chromiumos.test.api.AndroidProvisionResponseMetadata.installed_android_os', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ANDROIDOSIMAGE.oneofs_by_name['ref_oneof'].fields.append(
  _ANDROIDOSIMAGE.fields_by_name['gs_path'])
_ANDROIDOSIMAGE.fields_by_name['gs_path'].containing_oneof = _ANDROIDOSIMAGE.oneofs_by_name['ref_oneof']
_ANDROIDOSIMAGE.oneofs_by_name['ref_oneof'].fields.append(
  _ANDROIDOSIMAGE.fields_by_name['os_version'])
_ANDROIDOSIMAGE.fields_by_name['os_version'].containing_oneof = _ANDROIDOSIMAGE.oneofs_by_name['ref_oneof']
...
_ANDROIDPROVISIONRESPONSEMETADATA.fields_by_name['installed_android_os'].message_type = _INSTALLEDANDROIDOS
...
DESCRIPTOR.message_types_by_name['InstalledAndroidOS'] = _INSTALLEDANDROIDOS

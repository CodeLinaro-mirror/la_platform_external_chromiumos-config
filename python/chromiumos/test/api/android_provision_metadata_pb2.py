...
_ANDROIDOSIMAGE.fields_by_name['os_version'].containing_oneof = _ANDROIDOSIMAGE.oneofs_by_name['location_oneof']
...
_GSPATH.fields_by_name['file']._options = None

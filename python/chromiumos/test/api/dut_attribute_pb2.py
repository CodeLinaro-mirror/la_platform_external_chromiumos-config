...
DutAttribute = _reflection.GeneratedProtocolMessageType('DutAttribute', (_message.Message,), dict(
  ...
  FlatConfigSource = _reflection.GeneratedProtocolMessageType('FlatConfigSource', (_message.Message,), dict(
  ...
  HwidSource = _reflection.GeneratedProtocolMessageType('HwidSource', (_message.Message,), dict(
...
DutTarget = _reflection.GeneratedProtocolMessageType('DutTarget', (_message.Message,), dict(

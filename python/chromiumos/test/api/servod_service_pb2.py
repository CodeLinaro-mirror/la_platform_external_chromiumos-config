...
_SERVODSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='LogCheckPoint',
    full_name='chromiumos.test.api.ServodService.LogCheckPoint',
    index=4,
    containing_service=None,
    input_type=_LOGCHECKPOINTREQUEST,
    output_type=_LOGCHECKPOINTRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='SaveLogs',
    full_name='chromiumos.test.api.ServodService.SaveLogs',
    index=5,
    containing_service=None,

...
_COVERAGERULEBQROW = _descriptor.Descriptor(
  name='CoverageRuleBqRow',
  full_name='chromiumos.test.api.CoverageRuleBqRow',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='host', full_name='chromiumos.test.api.CoverageRuleBqRow.host', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='project', full_name='chromiumos.test.api.CoverageRuleBqRow.project', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='path', full_name='chromiumos.test.api.CoverageRuleBqRow.path', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='coverage_rule', full_name='chromiumos.test.api.CoverageRuleBqRow.coverage_rule', index=3,
...
_COVERAGERULEBQROW.fields_by_name['coverage_rule'].message_type = _COVERAGERULE
DESCRIPTOR.message_types_by_name['CoverageRule'] = _COVERAGERULE
DESCRIPTOR.message_types_by_name['CoverageRuleBqRow'] = _COVERAGERULEBQROW
...
CoverageRuleBqRow = _reflection.GeneratedProtocolMessageType('CoverageRuleBqRow', (_message.Message,), {
  'DESCRIPTOR' : _COVERAGERULEBQROW,
  '__module__' : 'chromiumos.test.api.coverage_rule_pb2'
  # @@protoc_insertion_point(class_scope:chromiumos.test.api.CoverageRuleBqRow)
  })
_sym_db.RegisterMessage(CoverageRuleBqRow)

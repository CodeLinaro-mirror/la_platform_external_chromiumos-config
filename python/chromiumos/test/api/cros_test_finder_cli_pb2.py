...
CrosTestFinderRequest = _reflection.GeneratedProtocolMessageType('CrosTestFinderRequest', (_message.Message,), dict(
...
CrosTestFinderResponse = _reflection.GeneratedProtocolMessageType('CrosTestFinderResponse', (_message.Message,), dict(

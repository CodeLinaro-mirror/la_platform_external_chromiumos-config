...
_GENERICTEMPLATE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='docker_artifact_dir', full_name='chromiumos.test.api.GenericTemplate.docker_artifact_dir', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='additional_volumes', full_name='chromiumos.test.api.GenericTemplate.additional_volumes', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='expose', full_name='chromiumos.test.api.GenericTemplate.expose', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='args', full_name='chromiumos.test.api.GenericTemplate.args', index=3,
